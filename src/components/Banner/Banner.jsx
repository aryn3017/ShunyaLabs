...
function Banner() {
  ...
  return (
    <div className={`${No} fixed ssm:right-1 bottom-5 right-5 rounded-2xl bg-ban-img bg-no-repeat bg-cover border-2 border-black z-50 shadow-2xl ssm:text-sm`}>
      <div className=' backdrop-blur-sm rounded-2xl bg-green-300 bg-opacity-20'>
        <p className=' text-center border-b-2 font-poppins  border-black font-medium'>WORKSHOP ALERT</p>
