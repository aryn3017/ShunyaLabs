...
export default function Banner() {
  let visi=""
  return (
    <section className={`${visi} absolute py-[60px] `}>
      <div className="mx-auto px-4 sm:container">
        <div className="relative flex max-w-[415px] items-center rounded-lg border border-stroke bg-white px-5 py-4 shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark">
          <button onClick={()=>visi='hidden'} className="absolute right-3 top-3 text-dark-5 hover:text-red dark:text-dark-6">
            <svg
              width={14}
              height={14}
              viewBox="0 0 14 14"
          ...
          <div className="mr-[18px] h-[54px] w-full max-w-[54px] overflow-hidden rounded-full">
            <img
              src="https://cdn.tailgrids.com/2.2/assets/core-components/images/toast/image-01.png"
              alt="user image"
