  ...
  return (
    <>
      <div className="   flex justify-center bg-gray-100 pb-10">
        <a href="https://www.iitr.ac.in/~DM/Tarun_Sharma" className=" grid-flow-col shadow-xl mb-10 flex flex-row ssm:flex-col ssm:rounded-md ssm:mx-5 rounded-l-full rounded-r-full bg-gradient-to-r from-slate-400 to-gray-100 p-3">
