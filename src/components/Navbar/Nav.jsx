...
function Navbar() {
  return (
    <header className="text-gray-600 body-font bg-nav-img bg-cover ">
      <div className=" mx-auto flex flex-wrap p-3 ssm:px-0 justify-between backdrop-blur-sm bg-black bg-opacity-30 flex-row">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          <img src='/logo.png' className=" ml-10 ssm:ml-0 w-20 h-20 text-black p-2  " viewBox="0 0 24 24"/>
          <span className=" text-2xl border-white border-2 px-2 font-poppins font-bold text-white">SHUNYA LAB</span>
        </a>
