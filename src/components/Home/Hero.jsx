...
function Hero() {
  return (
    ...
    <div className=" flex flex-row mx-20 ssm:mx-5 justify-between mt-10 -z-10">
      ...
      <div className=" ssm:flex-col flex flex-row mb-5 -z-10 bg-white bg-opacity-20 rounded-3xl p-4 backdrop-blur-2xl "><p className=" mr-5 ssm:mb-3 text-left ssm:text-center font-extrabold font-playwrite text-xl bg-gradient-to-tl from-green-500 via-blue-600 to-green-500 bg-clip-text text-transparent">Our Vision</p>
        ...
        <div className="flex flex-row ssm:flex-col p-3 rounded-3xl bg-white bg-opacity-20 backdrop-blur-2xl">
          <div className="flex text-xl items-center font-playwrite font-extrabold mr-5 bg-gradient-to-tl from-green-500 via-blue-600 to-green-500 bg-clip-text text-transparent text-left ssm:text-center ssm:block ssm:mb-3 ssm:text-2xl">
            Our mission
          </div>
          <div>
